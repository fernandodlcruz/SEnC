...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => '3306', 'dbname' => 'eunoc863_mtc', 'user' => 'eunoc863_mtcadm', 'password' => 'P04[RE7]WW+)', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array('enum' => 'string', 'point' => 'string', 'bit' => 'string'));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\FingersCrossedHandler($this->get('monolog.handler.nested'), 400, '200', true, true);
    }
    protected function getMonolog_Handler_MauticService()
    {
        return $this->services['monolog.handler.mautic'] = new \Monolog\Handler\RotatingFileHandler(($this->targetDirs[2].'/logs/mautic_prod.php'), 7, 250, true);
    }
    protected function getMonolog_Handler_NestedService()
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\RotatingFileHandler(($this->targetDirs[2].'/logs/prod.php'), 7, 400, true);
    }
    ...
    {
        return $this->services['twig.controller.exception'] = new \Mautic\CoreBundle\Controller\ExceptionController($this->get('twig'), false);
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56eed94657f7a7.28918328'), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56eed94657f7a7.28918328'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $c, 'oauth2_area', $b, true), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56eed94657f7a7.28918328'), 4 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $c, 'oauth1_area', $b, true), 5 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56eed94657f7a7.28918328'), 6 => new \FOS\OAuthServerBundle\Security\Authentication\Provider\OAuthProvider($a, $this->get('fos_oauth_server.server'), $c), 7 => $d, 8 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $c, 'main', $b, true), 9 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($c, 'fea170e457ef7b5ed5e818d4e7308e333bd50019', 'main'), 10 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56eed94657f7a7.28918328')), true);
                ...
                'MauticCoreBundle' => array(
                    ...
                    'config' => array(
                        ...
                        'parameters' => array(
                            ...
                            'rememberme_key' => '4a55d12a8cc67a9fba7f476d7975e2c7c172c80f',
